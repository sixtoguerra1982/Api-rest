...
from utils.base import mixins, views
...
class GenericAPIView(views.APIView):
    ...
    def get_validator(self, instance=None, data=None,
        ...
        return validator_class(instance, data=data,
                               many=many, partial=partial, context=context)

    def get_update_validator(self, instance=None, data=None,
                      files=None, many=False, partial=False):
        """
        Return the validator instance that should be used for validating the
        input, and for serializing output.
        """
        validator_class = self.get_update_validator_class()
        context = self.get_extra_context()
        return validator_class(instance, data=data,
                               many=many, partial=partial, context=context)
    ...
    def get_update_validator_class(self):
        validator_class = self.update_validator_class
        if validator_class is not None:
            return validator_class
        else:
    ...
    def get_model(self):
        """
        Return the model from queryset
        :Class Model: 
        """
